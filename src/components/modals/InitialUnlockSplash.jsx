...
import { Compass, Sparkles, Waves, ArrowRight } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Prominent Direct Entry Shortcut Hub (Large, Clickable, High Z-Index) */}
                <div 
                    onClick={(e) => e.stopPropagation()}
                    onPointerDown={(e) => e.stopPropagation()}
                    onTouchStart={(e) => e.stopPropagation()}
                    className="mt-8 flex flex-col sm:flex-row items-center gap-3.5 z-40 pointer-events-auto w-full max-w-md px-2"
                >
                    ...
                    <motion.button
                        ...
                        className="w-full sm:flex-1 py-3.5 px-5 rounded-2xl bg-[#E7FF00] hover:bg-white text-black font-mono text-xs font-black tracking-widest uppercase transition-all shadow-[0_0_30px_rgba(231,255,0,0.8)] hover:shadow-[0_0_40px_rgba(255,255,255,0.9)] flex items-center justify-center gap-2 cursor-pointer"
                    >
