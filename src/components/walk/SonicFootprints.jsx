...
export function SonicFootprints({ isScrollingUp }) {
    return (
        <>
            ...
            <div className="absolute inset-x-0 bottom-4 sm:bottom-0 h-52 pointer-events-none z-25 flex flex-col items-center justify-end overflow-hidden">
                <AnimatePresence>
                    {isScrollingUp && (
                        <motion.div
            ...
            <div className="absolute inset-0 pointer-events-none flex flex-col justify-end pb-7 sm:pb-8 px-4 text-center z-20">
